...
This code is adopted from the first fastai course materials created by Jermey Howard, and Rachel Thomas.
The materials for their first course are available from
    www.fast.ai
"""
